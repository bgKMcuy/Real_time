...
class Fragment1 : Fragment() {
    ...
    private fun mois(nilai: Double, data: String) {
        ...
        when (nilai) {
            in 0.0..40.0 -> {
                if (mapDou["mois"]!! >= 40){
                    showNotif(2,"Tanah Kering.", "2", "Moisture 1", "Notif Kelembapan Tanah")
                }
            }
            in 76.0..100.0 -> {
                if (mapDou["mois"]!! <= 75){
                    showNotif(2,"Tanah Basah.", "2", "Moisture 1", "Notif Kelembapan Tanah")
                }
            }
            else -> {}
        }
    ...
    private fun pH(nilai: Double, data: String) {
        ...
        when (nilai){
            in 3.0..5.4 -> {
                if (mapDou["pH"]!! >= 5.4) {
                    showNotif(3,"pH Rendah.", "3", "pH 1", "Notif pH Tanah")
                }
            }
            in 6.6..9.0 -> {
                if (mapDou["pH"]!! <= 6.6) {
                    showNotif(3,"pH Tinggi.", "3", "pH 1", "Notif pH Tanah")
                }
            }
            else -> {}
        }
    ...
    private fun eC(nilai: Int, data: String) {
        ...
        when (nilai) {
            in 0..3740 -> {}
                ...
                if (mapInt["ec"]!! <= 3740){
                    showNotif(4,"EC Tinggi.", "4", "EC 1", "Notif DHL Tanah")
                }
            }
        }
