...
//                        kalium(kal)
    ...
    private fun dist(nilai: Int) {
        ...
        when (nilai) {
            ...
            in 1..2 -> {
                ...
                if (mapInt["dist"]!! <= 2){
                    showNotif(5,"Air Pasang!", "5", "Distance 2", "Notif Ketingian Air")
                }
            }
        }
    ...
    private fun mois(nilai: Double) {
        ...
        when (nilai) {
            in 0.0..40.0 -> {
                if (mapDou["mois"]!! >= 40){
                    showNotif(6,"Tanah Kering.", "6", "Moisture 2", "Notif Kelembapan Tanah")
                }
            }
            in 76.0..100.0 -> {
                if (mapDou["mois"]!! <= 75){
                    showNotif(6,"Tanah Basah.", "6", "Moisture 2", "Notif Kelembapan Tanah")
                }
            }
            else -> {}
        }
    ...
    private fun pH(nilai: Double) {
        ...
        when (nilai){
            in 3.0..5.4 -> {
                if (mapDou["pH"]!! >= 5.4) {
                    showNotif(7,"pH Rendah.", "7", "pH 2", "Notif pH Tanah")
                }
            }
            in 6.6..9.0 -> {
                if (mapDou["pH"]!! <= 6.6) {
                    showNotif(7,"pH Tinggi.", "7", "pH 2", "Notif pH Tanah")
                }
            }
            else -> {}
        }
    ...
    private fun eC(nilai: Int) {
        ...
        when (nilai) {
            in 0..3740 -> {}
                ...
                if (mapInt["ec"]!! <= 3740){
                    showNotif(8,"EC Tinggi.", "8", "EC 2", "Notif DHL Tanah")
                }
            }
        }
...
//        val notifId = SimpleDateFormat("ddHHmmss", Locale.US).format(date).toInt()
        ...
        val builder = NotificationCompat.Builder(requireContext(), CHANNEL_ID)
            ...
            .setContentTitle("Peringatan! Field 2")
            .setContentText(msg)
